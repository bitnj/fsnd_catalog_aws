from fsnd_item_catalog import app
...
CLIENT_ID = json.loads(open('/var/www/fsnd_item_catalog/fsnd_item_catalog/client_secrets.json', 'r').read())['web']['client_id']
...
def gconnect():
    ...
    try:
        ...
        oauth_flow = flow_from_clientsecrets(
            '/var/www/fsnd_item_catalog/fsnd_item_catalog/client_secrets.json', scope='')
...
def fbconnect():
    ...
    app_id = json.loads(
        open(
            '/var/www/fsnd_item_catalog/fsnd_item_catalog/fb_client_secrets.json',
            'r').read())['web']['app_id']
    app_secret = json.loads(open('/var/www/fsnd_item_catalog/fsnd_item_catalog/fb_client_secrets.json',
